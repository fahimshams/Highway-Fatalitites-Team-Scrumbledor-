...
var EventSystem = (function()
{
	...
	class EventSystemClass
	{
		...
		RaiseEvent(eventName, argsObject = null, requireListener = false)
		{
			// Get event data.
			let callbackData = this.eventMap.get(eventName);
			if (callbackData == undefined)
	...
	let instance = new EventSystemClass();
